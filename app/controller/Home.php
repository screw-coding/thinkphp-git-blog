...
class Home extends BaseController
{
    ...
    public function exportSite()
    {
        ...
        $thfiles = get_dir_file_info(root_path()."/public/theme/" . $theme, false);
        ...
        copy(root_path()."/public/robots.txt", GB_SITE_DIR . "/robots.txt");
        copy(root_path()."/public/favicon.ico", GB_SITE_DIR . "/favicon.ico");
    ...
    public function feed()
    {
        ...
        $feedXml = view('/home/feed', $data)->getContent();
        if ($this->export) {
            return $feedXml;
        }
    ...
    private function render($tpl)
    {
        ...
        $this->response->content($htmlPage);
        return $this->response->getContent();
